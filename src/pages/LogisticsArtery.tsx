  ...
  return (
    <div className="space-y-10 pb-20 overflow-hidden">
      ...
      <div className="ui-panel bg-slate-900 rounded-[24px] sm:rounded-[48px] p-5 sm:p-8 lg:p-12 text-white relative overflow-hidden min-h-[320px] sm:min-h-[400px] flex flex-col justify-end shadow-2xl">
         <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-sky-500/10 blur-[150px] rounded-full -mr-[400px] -mt-[400px]" />
         ...
         <div className="absolute top-20 left-20 right-20 h-0.5 bg-white/5 flex items-center justify-between">
            <div className="w-4 h-4 rounded-full bg-indigo-500 shadow-[0_0_20px_#6366f1]" />
            <motion.div 
              animate={{ x: [0, 800], opacity: [0, 1, 0] }}
              transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
              className="w-12 h-12 bg-sky-400/20 rounded-full flex items-center justify-center border border-sky-400/40"
            >
               <Truck size={14} className="text-sky-400" />
            </motion.div>
            <div className="w-4 h-4 rounded-full bg-emerald-500 shadow-[0_0_20px_#10b981]" />
            <div className="w-4 h-4 rounded-full bg-rose-500 shadow-[0_0_20px_#f43f5e]" />
         </div>
         ...
         <div className="relative z-10 space-y-4">
            ...
            <div className="flex items-center gap-4 text-slate-500 text-xs font-black uppercase tracking-[0.4em]">
               <Activity size={16} className="text-sky-400 animate-pulse" /> Live Backbone Pulse Sync 2026
            </div>
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between px-2">
               ...
               <span className="text-[10px] font-black text-sky-500">View Network Topology</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {arteries.map(node => (
                 <div 
                  key={node.id}
                  className="ui-card bg-white rounded-[24px] sm:rounded-[32px] p-5 sm:p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-sky-500 group transition-all"
                 >
                    ...
                    <div className="space-y-1">
                       <div className="text-[9px] font-black text-sky-500 uppercase tracking-widest">{node.type}</div>
         ...
         <div className="space-y-8">
            <div className="ui-panel bg-slate-900 rounded-[24px] sm:rounded-[40px] p-5 sm:p-8 lg:p-10 text-white space-y-10 relative overflow-hidden">
               ...
               <h3 className="text-sm font-black uppercase tracking-[0.2em] flex items-center gap-3">
                  <Droplets className="text-sky-400" /> Fluid Dynamics
               </h3>
               ...
               <div className="space-y-10">
                  ...
                  <div className="space-y-4">
                     <div className="flex justify-between text-[10px] font-black uppercase tracking-widest">
                        ...
                        <span className="text-amber-400">Peak Load</span>
                     </div>
                     <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                        <motion.div initial={{ width: 0 }} animate={{ width: '45%' }} className="h-full bg-sky-500" />
                     </div>
                  </div>
               </div>
            ...
            <div className="ui-card bg-white rounded-[24px] sm:rounded-[32px] p-5 sm:p-8 border border-slate-200 shadow-sm space-y-4 flex items-center gap-6">
               <div className="w-16 h-16 bg-sky-50 rounded-2xl flex items-center justify-center text-sky-500 shadow-xl shadow-sky-50">
